...
<div className="App">
      ...
      <div className="container">
          <Routes>
            ...
            <Route path="/admin/products" element={<Protect ><AdminProducts/></Protect>}  />
            <Route path="/admin/products/:id/edit" element={<Protect ><Edit/></Protect>} />
            <Route path="/admin/products/new" element={<Protect ><New /></Protect>} />
